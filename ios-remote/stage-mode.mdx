...
<Tip>
  Set this up under a playlist item's **Actions → Countdown Banner**, choosing **Display: Stage Only**. A "Program" countdown instead shows on the audience output (and optionally mirrors onto a TV Wall Stage quadrant). See [Countdown banner](/web-app/playlists#countdown-banner).
</Tip>
