...
description: "Pair your Apple TV with a LightLoop feed using your Feed ID."
---

{/* SCREENSHOT PLACEHOLDER: tvOS setup screen showing two input fields: Server URL and Feed ID, with a Connect button */}

Before your Apple TV can play content, it needs to connect to a feed. You'll need a piece of information from the web dashboard:

- **Feed ID** — the 6-character code for the specific feed (e.g., `AB12CD`)

It's found on the **Feeds** page in the dashboard.
...
<Steps>
  ...
  <Step title="Enter the Feed ID" stepNumber={2}>
  ...
  <Step title="Press Connect" stepNumber={3}>
    ...
    If the connection fails, double-check the Feed ID.
