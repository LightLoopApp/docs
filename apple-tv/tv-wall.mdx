...
For timed media (video, audio, songs with a track), the Stage Display also shows a small **time-remaining** pill, and **stage-only speaker timers** appear as a pill in the upper-left corner. Set these up under a playlist item's **Actions → Countdown Banner** (see [Countdown banner](/web-app/playlists#countdown-banner)).
